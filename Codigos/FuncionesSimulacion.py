...
def GenerarTabla(nombrePDF,Desc,TiempoSimulado, ClientesIngresados,ClientesDespachados,ProductosDespachados,ColasPromedio,MaximaCola):
    ...
    GenerarPDF(data,nombrePDF,Desc)

def GenerarPDF(data,nombrePDF,Desc):
